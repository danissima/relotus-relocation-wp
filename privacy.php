    ...
    <div class="container">
      ...
      <div class="block block_equal-padding plain-html">
        ...
        <p>
          ...
          о&nbsp;персональных данных) и&nbsp;определяет
        ...
        <p>
          ...
          веб-сайта&nbsp;<a class="link" href="https://relotus-relocation.com">https://relotus-relocation.com</a>.
        </p>
        ...
        <p>
          ...
          выполнения
          обязанностей, предусмотренных Законом о&nbsp;персональных данных и&nbsp;принятыми в&nbsp;соответствии
          с&nbsp;ним нормативными
        ...
        <p>
          ...
          обработку
          и&nbsp;уничтожить персональные данные в&nbsp;порядке и&nbsp;случаях, предусмотренных Законом
        ...
        <p>
          ...
          данных. Оператор
          принимает необходимые меры и/или&nbsp;обеспечивает их&nbsp;принятие по&nbsp;удалению или уточнению неполных
          или неточных
          данных.
        </p>
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>Федеральный закон «Об&nbsp;информации, информационных технологиях и&nbsp;о&nbsp;защите информации»
                от&nbsp;27.07.2006&nbsp;N 149-ФЗ</td>
            </tr>
            <tr>
              <td>Виды обработки<br>персональных данных</td>
        ...
        <p>
          ...
          почты&nbsp;<a class="link" href="mailto:privacy@thismywebsite.com">privacy@thismywebsite.com</a>.
        </p>
